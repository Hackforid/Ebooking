...
from views.login import LoginHandler, LogoutHandler, HelloWorldHandler
...
from views.api.hotel_cooped import HotelCoopedAPIHandler, HotelCoopOnlineAPIHandler
